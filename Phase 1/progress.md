...
| P1-005 | done        | Prepare logo assets for web use.                                      | Codex | 2026-04-17 | 2026-04-17 | Restored the original logo artwork and added a corrected transparent PNG so the A/e counters inherit the glass nav background. Verified with `npm run build` and browser screenshots. |
...
| P1-010 | review      | Build About page with agent profiles.                                 | Codex | 2026-04-17 | 2026-04-24 | Added five provided agent names in order and updated the What sets us apart cards from Website Notes. Voice buttons are disabled until real clips are added. |
...
| P1-012 | review      | Build Contact/Book Demo form.                                         | Codex | 2026-04-17 | 2026-04-24 | Updated fields from Website Notes: first/last name, designation, company, business email, contact number, monthly appointment volume dropdown, and campaign-management message. Formspree endpoint still needs final owner confirmation. |
| P1-013 | review      | Add responsive behavior for mobile/tablet/desktop.                    | Codex | 2026-04-17 | 2026-05-05 | Implemented hero chips/copy, snappy homepage service carousel, services auto-rotating tabs with progress line, mobile service selector, and mobile package carousel. Touched `src/pages/index.astro`, `src/pages/services.astro`, `src/styles/global.css`, `src/utils/carouselState.mjs`, `tests/carousel-state.test.mjs`. Verified `node tests/carousel-state.test.mjs`, `npm run build`, and Playwright desktop/mobile screenshots. Added client review single-card snap carousel on 2026-05-05 and re-verified helper test, build, and desktop/mobile review screenshots.                                                |
...
| P1-021 | done        | UI redesign: draggable carousel, glassmorphism nav, modern reviews, rounded corners. | Antigravity | 2026-04-18 | 2026-04-18 | Comprehensive UI polish pass across all pages. Implemented mobile-specific carousel behavior, glassmorphism nav, and rounded corners. |
| P1-022 | done        | Rehaul services page, hide About nav/content, and add FAQ demo CTA.    | Codex | 2026-05-03 | 2026-05-03 | Rebuilt `src/pages/services.astro` with exact owner-provided services/packages, moved Why Americall cards into Services, generated service imagery plus WebP copies in `public/images/services/`, removed About from nav/footer and redirected `/about/`, added FAQ demo CTA. Verified `npm run build`, `/about/` 301 redirect, and Playwright desktop/mobile screenshots. |
| P1-023 | done        | Add homepage service teaser copy and Explore Services border trail.     | Codex | 2026-05-04 | 2026-05-04 | Added homepage-only shorter service carousel copy in `src/pages/index.astro`, added a subtle periodic red border trail on Explore Services in `src/styles/global.css`, and switched visible site copy to U.S. spellings including Dialer and Qualified. Verified `npm run build`, source spelling search, and Playwright desktop/mobile screenshots. |
| P1-024 | done        | Fix Explore Services border trail animation.                           | Codex | 2026-05-04 | 2026-05-04 | Reworked the Explore Services animation as a thin conic border mask with subtle glow, made homepage service cards link to matching `/services/#...` panels, and updated Services tabs to activate from URL hashes. Verified `npm run build` and Playwright hash screenshots for Campaign Management and Administrative Support. |
| P1-025 | done        | Improve large-screen page hero distribution.                           | Codex | 2026-05-04 | 2026-05-04 | Capped homepage hero desktop height, tuned standard desktop vs ultra-wide image sizing, and preserved mobile layout. Verified `npm run build` plus 1440x900, 2560x1400 home screenshots and 1440 services screenshot. |
